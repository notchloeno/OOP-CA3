...
public class SocialMedia implements SocialMediaPlatform {
	 ...
	 * @return the post
	 * @throws PostIDNotRecognisedException the post id not recognised exception
	 */
	...
	/**
	 * Verifies post message is between 1 and 100 characters
	 *
	 * @param message the message
	 * @throws InvalidPostException the invalid post exception
	 */
	...
	/**
	 * Show post children details string builder.
	 *
	 * @param id    the id
	 * @param depth the depth
	 * @return the string builder
	 * @throws PostIDNotRecognisedException the post id not recognised exception
	 * @throws NotActionablePostException   the not actionable post exception
	 */
